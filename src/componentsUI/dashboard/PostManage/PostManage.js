...
import HeaderPost from '../../Home/HeadingPost/HeadingPost'
        ...
        <div>
            ...
            <div className="d-flex row" >
                ...
                <div className="col-md-9 " style={{ marginTop: '60px' }}>
                    <div className="" style={{boxShadow: '3px 3px 10px grey', width:'90%', marginTop:'60px', padding:'15px'}}>
                            {
                                posts.map(post =><ManagePost post={post}></ManagePost>)
                            }
                    </div>
                </div>
            </div>
